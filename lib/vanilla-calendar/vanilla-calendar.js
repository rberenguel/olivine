...
!(function (e, t) {
  ...
  const k = (e, t, n, a) => {
    ...
    q = (e, t, n, a, s) => {
      ...
      return (
        (l.className = `${e.CSSClasses.yearsYear}${n === s ? ` ${e.CSSClasses.yearsYearSelected}` : a ? ` ${e.CSSClasses.yearsYearDisabled}` : ""}`),
    ...
    R = (e, t, n, a, s, l) => {
      ...
      return (
        (i.className = `${e.CSSClasses.monthsMonth}${n === l ? ` ${e.CSSClasses.monthsMonthSelected}` : s ? ` ${e.CSSClasses.monthsMonthDisabled}` : ""}`),
        (i.title = a),
        (i.innerText = `${e.settings.visibility.monthShort ? a.substring(0, 3) : a}`),
    ...
    te = (e, t, n, a) =>
      `<label class="${t}"><input type="text"name="${e}"maxlength="2"value="${n}"${a ? "disabled" : ""}></label>`,
    ne = (e, t, n, a, s, l) =>
        ...
        ((e, t, n) => {
          ...
          for (let s = 0; s < n.length; s++) {
            ...
            (i.className = `${e.CSSClasses.weekDay}`),
              (i.className = `${e.CSSClasses.weekDay}${e.settings.visibility.weekend && e.settings.iso8601 ? (5 === s || 6 === s ? ` ${e.CSSClasses.weekDayWeekend}` : "") : !e.settings.visibility.weekend || e.settings.iso8601 || (0 !== s && 6 !== s) ? "" : ` ${e.CSSClasses.weekDayWeekend}`}`),
              (i.innerText = `${l}`),
              t.appendChild(i);
          }
        })(e, n, t),
