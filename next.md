...
2.  **Define the Search Service in `search.js`**
    ...
    export function initializeSearch() {
      fileNameIndex = new MiniSearch({ fields: ['title', 'path'], storeFields: ['title', 'path'] });
      contentIndex = new MiniSearch({ fields: ['title', 'content'], storeFields: ['title', 'path'] });
    }
    
    export function getFileNameIndex() { return fileNameIndex; }
    export function getContentIndex() { return contentIndex; }
