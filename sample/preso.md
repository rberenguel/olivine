...
[fn1]: An ~Obsidian~ Olivine plugin by [rberenguel](https://www.mostlymaths.net)
...
[getpreso]: You can find the _Obsidian_ plugin [here](https://github.com/rberenguel/obsidian-preso-plugin)
